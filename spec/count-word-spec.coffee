...
describe "CountWord", ->
  ...
  beforeEach ->
    ...
    activationPromise = atom.packages.activatePackage('count-word')

  describe "when the count-word:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'count-word:toggle'
        expect(countWordPanel.isVisible()).toBe false
    ...
    it "hides and shows the view", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'count-word:toggle'
        expect(countWordElement).not.toBeVisible()
